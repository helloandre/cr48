...
"i686-linux-thread-multi-2.6.35-arch" or
	die "Errno architecture (i686-linux-thread-multi-2.6.35-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
