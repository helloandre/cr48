...
cf_time='Mon Nov  8 03:47:48 UTC 2010'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg4='-Doptimize=-march=i686 -mtune=generic -O2 -pipe'
...
config_argc='19'
config_args='-des -Dusethreads -Duseshrplib -Doptimize=-march=i686 -mtune=generic -O2 -pipe -Dprefix=/usr -Dinstallprefix=/usr -Dvendorprefix=/usr -Dprivlib=/usr/share/perl5/core_perl -Darchlib=/usr/lib/perl5/core_perl -Dsitelib=/usr/share/perl5/site_perl -Dsitearch=/usr/lib/perl5/site_perl -Dvendorlib=/usr/share/perl5/vendor_perl -Dvendorarch=/usr/lib/perl5/vendor_perl -Dscriptdir=/usr/bin/core_perl -Dsitescript=/usr/bin/site_perl -Dvendorscript=/usr/bin/vendor_perl -Dinc_version_list=none -Dman1ext=1perl -Dman3ext=3perl'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
ksh=''
ld='cc'
lddlflags='-shared -march=i686 -mtune=generic -O2 -pipe -L/usr/local/lib -fstack-protector'
...
mydomain='.(none)'
myhostname='puffin'
myuname='linux puffin 2.6.35-arch #1 smp preempt sat oct 30 19:57:05 utc 2010 i686 amd athlon(tm) 64 processor 3000+ authenticamd gnulinux '
n='-n'
need_va_copy='undef'
